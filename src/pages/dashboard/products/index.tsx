...
import { LayoutGrid, CircleCheck, AlertTriangle, PackageX } from "lucide-react";
...
const rows: ProductRow[] = [
  { name: "HDPE Granules", code: "RAW-001", category: "Raw Material", brand: "ù", pkgType: "Bags", qty: "143 kg", min: "500 kg", status: "warning" },
  { name: "PP Woven Sack 50kg", code: "PKG-011", category: "Packaging", brand: "ù", pkgType: "Sacks", qty: "2200 pc", min: "500 pc", status: "success" },
  { name: "PremiumBond Tape", code: "PKG-045", category: "Packaging", brand: "BondPro", pkgType: "Roll", qty: "200 pc", min: "1000 pc", status: "warning" },
  { name: "LDPE Film Roll", code: "RAW-007", category: "Raw Material", brand: "ù", pkgType: "Roll", qty: "890 kg", min: "200 kg", status: "success" },
  { name: "Corrugated Sheet B", code: "PKG-022", category: "Packaging", brand: "ù", pkgType: "Sheet", qty: "8 pc", min: "100 pc", status: "danger" },
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Total SKUs" value={1284} icon={LayoutGrid} iconColor="#EA580C" iconBg="#FFF4F0" ringColor="#F97316" ringValue={72} />
        <StatCard label="Active Products" value={1186} icon={CircleCheck} iconColor="#16A34A" iconBg="#ECFDF3" ringColor="#22C55E" ringValue={85} />
        <StatCard label="Low Stock Items" value={37} icon={AlertTriangle} iconColor="#D97706" iconBg="#FEF3C7" ringColor="#F59E0B" ringValue={28} />
        <StatCard label="Out of Stock" value={12} icon={PackageX} iconColor="#DC2626" iconBg="#FEE2E2" ringColor="#EF4444" ringValue={9} />
      </div>
